        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-stone-800">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-serif-display font-bold text-xl text-white block">
                  Atrana
                </span>
            ...
            <p className="text-xs text-stone-400 leading-relaxed">
              Warisan kuliner nasi goreng wok tradisi dan rempah pusaka Indonesia. Menghadirkan jamuan autentik dengan kenyamanan pemesanan jadwal meja online.
            </p>
